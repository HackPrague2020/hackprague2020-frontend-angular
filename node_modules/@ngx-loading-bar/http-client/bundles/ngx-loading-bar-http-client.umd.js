(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@ngx-loading-bar/core'),require('@angular/common/http'),exports, require('@ngx-loading-bar/core'), require('@angular/core'), require('@angular/common/http'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@ngx-loading-bar/http-client', ['@angular/core','@ngx-loading-bar/core','@angular/common/http','exports', '@ngx-loading-bar/core', '@angular/core', '@angular/common/http', 'rxjs/operators'], factory) :
    (global = global || self, factory(global.ng.core,global.ngxLoadingBar.core,global.ng.common.http,(global['ngx-loading-bar'] = global['ngx-loading-bar'] || {}, global['ngx-loading-bar']['http-client'] = {}), global.core, global.ng.core, global.ng.common.http, global.rxjs.operators));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, core, core$1, http, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var LoadingBarInterceptor = /** @class */ (function () {
        ...
        LoadingBarInterceptor.prototype.intercept = function (req, next) {
            ...
            }), operators.finalize(function () { return started && ref.complete(); }));
        };
        LoadingBarInterceptor.ctorParameters = function () { return [
            { type: core.LoadingBarService }
        ]; };
        LoadingBarInterceptor = __decorate([ __metadata("design:paramtypes", [core.LoadingBarService])
...
LoadingBarHttpClientModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function LoadingBarHttpClientModule_Factory(t) { return new (t || LoadingBarHttpClientModule)(); }, providers: [
    ...
    ], imports: [[http.HttpClientModule, core.LoadingBarModule], ɵngcc2.HttpClientModule, ɵngcc1.LoadingBarModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LoadingBarHttpClientModule, { imports: [ɵngcc2.HttpClientModule, ɵngcc1.LoadingBarModule], exports: [ɵngcc2.HttpClientModule, ɵngcc1.LoadingBarModule] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LoadingBarHttpClientModule, [{
        type: core$1.NgModule,
        args: [{
                imports: [http.HttpClientModule, core.LoadingBarModule],
                exports: [http.HttpClientModule, core.LoadingBarModule],
                providers: [
                    {
                        provide: http.HTTP_INTERCEPTORS,
                        useClass: LoadingBarInterceptor,
